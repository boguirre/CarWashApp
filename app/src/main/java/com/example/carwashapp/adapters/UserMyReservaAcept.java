...
public class UserMyReservaAcept extends RecyclerView.Adapter<UserMyReservaAcept.ViewHolder>{

    Context mCtx;
    private List<Reservas> reservasList;
    public UserMyReservaAcept(Context mCtx,List<Reservas>reservasList){
        this.mCtx=mCtx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.list_reserva_acept,null);

        return new UserMyReservaAcept.ViewHolder(view);
    }
